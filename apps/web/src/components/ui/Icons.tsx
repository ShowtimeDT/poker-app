...
export function PlayingCardIcon({
  ...
  className,
  size = 24,
}: IconProps & { suit: 'hearts' | 'diamonds' | 'clubs' | 'spades' }) {
  const suitPaths = {
    hearts: (
    ...
    clubs: (
      <path d="M12 2C9.79 2 8 3.79 8 6c0 1.48.81 2.75 2 3.45V11H8c-2.21 0-4 1.79-4 4s1.79 4 4 4c1.48 0 2.75-.81 3.45-2H11v3h2v-3h-.45c.7.64 1.97 2 3.45 2 2.21 0 4-1.79 4-4s-1.79-4-4-4h-2V9.45c1.19-.7 2-1.97 2-3.45 0-2.21-1.79-4-4-4z" />
    ),
    spades: (
      <path d="M12 2L4 12c0 3 2.5 5 5 5-.5 1-1.5 2-2 3h6c-.5-1-1.5-2-2-3 2.5 0 5-2 5-5L12 2z" />
    ),
  };
...
export function DealerButtonIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
